...
<template>
  <div class="navigation">
    ...
    <ul>
      ...
      <li v-if="isAuthenticated" @click="chatRoom">
        <span class="logout">ChatRoom</span>
      </li>
...
import { LIST_ROOM_REQUEST } from "actions/chatRoom";
...
export default {
  ...
  methods: {
    ...
    chatRoom: function() {
      this.$store.dispatch(LIST_ROOM_REQUEST).then(() => {
        this.$router.push("/chatRoom").catch(() => {});
      });
    }
  },
  computed: {
